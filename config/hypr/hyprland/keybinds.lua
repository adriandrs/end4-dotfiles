...
hl.bind("CTRL + grave", hl.dsp.global("quickshell:wallpaperSelectorToggle"),
...
hl.bind("CTRL + grave", hl.dsp.exec_cmd(qsIsAlive .. " || " .. qsScripts .. "/colors/switchwall.sh"))
...
require("custom.binds-side-mouse")
