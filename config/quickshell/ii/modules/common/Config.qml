    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string network: "env XDG_CURRENT_DESKTOP=GNOME /usr/bin/gnome-control-center wifi"
                property string manageUser: "env XDG_CURRENT_DESKTOP=GNOME /usr/bin/gnome-control-center system-users"
                property string networkEthernet: "env XDG_CURRENT_DESKTOP=GNOME /usr/bin/gnome-control-center network"
