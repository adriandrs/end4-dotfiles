...
Item {
    ...
    PopupWindow {
        ...
        // Vista previa en hover desactivada. Para reactivarla, cambia el false
        // inicial por: (popupMouseArea.containsMouse || root.buttonHovered)
        property bool shouldShow: false && appTopLevel && appTopLevel.toplevels && appTopLevel.toplevels.length > 0
