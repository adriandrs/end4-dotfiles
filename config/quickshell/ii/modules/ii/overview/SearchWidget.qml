...
Item { // Wrapper
    ...
    // overviewTabNav: navegacion de miniaturas cuando no hay busqueda activa.
    signal navRequested(int delta)
    ...
    Rectangle { // Background
        ...
        ColumnLayout {
            ...
            SearchBar {
                id: searchBar
            onOverviewNavRequested: delta => root.navRequested(delta)
            onOverviewActivateRequested: root.activateRequested()
