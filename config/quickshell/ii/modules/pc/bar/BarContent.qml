...
Item {
    ...
    readonly property bool isMaterial: PcConfig.options.bar.cornerStyle === 3
    ...
    readonly property var effectiveLeftLayout:   filterLayout(PcConfig.options.bar.layouts.leftLayout)
    readonly property var effectiveMiddleLayout: filterLayout(PcConfig.options.bar.layouts.middleLayout)
    readonly property var effectiveRightLayout:  filterLayout(PcConfig.options.bar.layouts.rightLayout)
    ...
    function shouldPaintMaterialPill(name) {
        if (PcConfig.options.bar.cornerStyle !== 3) return false;
    ...
    function getMaterialPillColor(name) {
        if (PcConfig.options.bar.cornerStyle !== 3) return Appearance.colors.colPrimaryContainer;
        switch(name) {
            case "media":
            case "sysTray":
    ...
    Rectangle {
        id: barBackground
        anchors.fill: parent
        anchors.margins: PcConfig.options.bar.cornerStyle === 1 ? Appearance.sizes.hyprlandGapsOut : 0
        color: (!centerOnly && PcConfig.options.bar.showBackground && PcConfig.options.bar.cornerStyle !== 2 && !root.isMaterial) 
            ? Appearance.colors.colLayer0 : "transparent"
        radius: PcConfig.options.bar.cornerStyle === 1 ? Appearance.rounding.windowRounding : 0
        border.width: (!centerOnly && PcConfig.options.bar.cornerStyle === 1) ? 1 : 0
    ...
    Rectangle {
        id: centerPill
        visible: centerOnly && PcConfig.options.bar.showBackground && PcConfig.options.bar.cornerStyle !== 2
        anchors.verticalCenter: parent.verticalCenter
        anchors.horizontalCenter: parent.horizontalCenter
        width: middleRow.implicitWidth + 10
        height: parent.height - (PcConfig.options.bar.cornerStyle === 1 ? Appearance.sizes.hyprlandGapsOut * 2 : 0)
        color: Appearance.colors.colLayer0
        radius: PcConfig.options.bar.cornerStyle === 1 ? Appearance.rounding.windowRounding : 0
        border.width: PcConfig.options.bar.cornerStyle === 1 ? 1 : 0
        border.color: Appearance.colors.colLayer0Border

        bottomLeftRadius:  PcConfig.options.bar.cornerStyle === 0 && !PcConfig.options.bar.bottom ? Appearance.rounding.screenRounding : radius
        bottomRightRadius: PcConfig.options.bar.cornerStyle === 0 && !PcConfig.options.bar.bottom ? Appearance.rounding.screenRounding : radius
        topLeftRadius:     PcConfig.options.bar.cornerStyle === 0 && PcConfig.options.bar.bottom  ? Appearance.rounding.screenRounding : radius
        topRightRadius:    PcConfig.options.bar.cornerStyle === 0 && PcConfig.options.bar.bottom  ? Appearance.rounding.screenRounding : radius
    }
    ...
    Item {
        ...
        Item {
            ...
            anchors.leftMargin: root.isMaterial ? (PcConfig.options.hyprland.general.gapsOut || 5) : (PcConfig.options.bar.cornerStyle === 1 ? 4 : 10)
            ...
            RowLayout {
                ...
                visible: !root.isMaterial
                anchors.fill: parent
                spacing: PcConfig.options.bar.borderless === "transparent" ? -7 : 2
                ...
                Component {
                    ...
                    Loader {
                        ...
                        Layout.topMargin: PcConfig.options.bar.bottom ? -5 : 3
        ...
        Item {
            ...
            anchors.rightMargin: root.isMaterial ? (PcConfig.options.hyprland.general.gapsOut || 5) : (PcConfig.options.bar.cornerStyle === 1 ? 4 : 10)
            anchors.top: parent.top
            anchors.bottom: parent.bottom
