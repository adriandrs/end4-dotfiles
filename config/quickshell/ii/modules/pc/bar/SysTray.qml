...
Item {
    ...
    readonly property bool isOnLeft: PcConfig.options.bar.layouts.leftLayout.includes("sysTray")
    ...
    GridLayout {
        ...
        RippleButton {
            ...
            contentItem: MaterialSymbol {
                ...
                text: PcConfig.options.bar.bottom ? "keyboard_control_key" : "expand_more"
