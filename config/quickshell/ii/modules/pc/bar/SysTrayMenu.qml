    ...
    MouseArea {
        ...
        Rectangle {
            ...
            anchors {
                left: parent.left
                right: parent.right
                verticalCenter: PcConfig.options.bar.vertical ? parent.verticalCenter : undefined
                top: PcConfig.options.bar.vertical ? undefined : PcConfig.options.bar.bottom ? undefined : parent.top
                bottom: PcConfig.options.bar.vertical ? undefined : PcConfig.options.bar.bottom ? parent.bottom : undefined
