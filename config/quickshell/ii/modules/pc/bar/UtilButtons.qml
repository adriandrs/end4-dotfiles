...
Item {
    ...
    Flow {
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showScreenSnip
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showColorPicker
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showScreenRecord
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showKeyboardToggle
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showWallpaperToggle
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showMicToggle
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showDarkModeToggle
            visible: active
        ...
        Loader {
            active: PcConfig.options.bar.utilButtons.showPerformanceProfileToggle
            visible: active
