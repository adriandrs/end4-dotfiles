...
import qs.modules.pc.sidebarLeft.anime
import QtQuick
...
Item {
    ...
    function handleInput(inputText) {
        if (inputText.startsWith(root.commandPrefix)) {
            ...
            Booru.makeRequest(tagList, Persistent.states.booru.allowNsfw, PcConfig.options.sidebar.booru.limit, pageIndex);
        }
    }
    ...
    ColumnLayout {
        ...
        Item {
            ...
            StyledListView { // Booru responses
                ...
                touchpadScrollFactor: PcConfig.options.interactions.scrolling.touchpadScrollFactor * 1.4
                mouseScrollFactor: PcConfig.options.interactions.scrolling.mouseScrollFactor * 1.4
