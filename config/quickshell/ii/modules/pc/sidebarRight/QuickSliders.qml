...
Rectangle {
    ...
    Column {
        ...
        Loader {
            ...
            visible: active
            active: PcConfig.options.sidebar.quickSliders.showBrightness
        ...
        Loader {
            ...
            visible: active
            active: PcConfig.options.sidebar.quickSliders.showVolume
            sourceComponent: QuickSlider {
        ...
        Loader {
            anchors { left: parent.left; right: parent.right }
            visible: active
            active: PcConfig.options.sidebar.quickSliders.showMic
            sourceComponent: QuickSlider {
                materialSymbol: "mic"
