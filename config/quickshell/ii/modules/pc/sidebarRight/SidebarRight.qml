...
Scope {
    ...
    readonly property bool centerOnly: PcConfig.options.bar.layouts.leftLayout.length === 0 && PcConfig.options.bar.layouts.rightLayout.length === 0 && !PcConfig.options.bar.vertical
    ...
    PanelWindow {
        ...
        margins {
            top: {
                ...
                switch (PcConfig.options.bar.cornerStyle) {
