...
import qs.modules.pc.sidebarRight.quickToggles.classicStyle
import qs.modules.pc.sidebarRight.bluetoothDevices
import qs.modules.pc.sidebarRight.nightLight
import qs.modules.pc.sidebarRight.volumeMixer
import qs.modules.pc.sidebarRight.wifiNetworks
import qs.modules.pc.sidebarRight.iconPicker
...
Item {
    ...
    readonly property var meaningfulPlayers: {
        const preferred = PcConfig.options.bar.media.preferredPlayer.trim().toLowerCase()
    ...
    Process {
        ...
        onExited: (code) => {
            if (code === 0) {
                ...
                if (path !== "") {
                    PcConfig.options.sidebar.bannerImage = path
                }
            }
        }
    }
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Loader {
                ...
                sourceComponent: PcConfig.options.sidebar.banner ? bannerComponent : normalComponent
                ...
                Component {
                    ...
                    Item {
                        ...
                        Rectangle {
                            id: sysRect
                            anchors.fill: parent
                            radius: PcConfig.options.hyprland.decoration.rounding - 2
                            ...
                            Rectangle {
                                ...
                                StyledImage {
                                    ...
                                    source: PcConfig.options.sidebar.bannerImage !== "" 
                                        ? PcConfig.options.sidebar.bannerImage 
                                        : PcConfig.options.background.wallpaperPath
                                    cache: false
                                    antialiasing: true
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    Image {
                                        id: avatarImage
                                        anchors.fill: parent
                                        source: PcConfig.options.profile.avatarPath !== "" 
                                            ? "file://" + PcConfig.options.profile.avatarPicture 
                                ...
                                StyledText {
                                    text: (PcConfig.options.profile.displayName === "" ? SystemInfo.username : PcConfig.options.profile.displayName) + "@" + SystemInfo.hostname
                            ...
                            ButtonGroup {
                                ...
                                QuickToggleButton {
                                    ...
                                    visible: PcConfig.options.sidebar.quickToggles.style === "android"
                                    buttonIcon: "edit"
            ...
            Loader {
                ...
                visible: active
                active: {
                    const configQuickSliders = PcConfig.options.sidebar.quickSliders
            ...
            Loader {
                active: root.activePlayer !== null && GlobalStates.sidebarRightOpen && PcConfig.options.sidebar.mediaPlayer
                visible: active
                Layout.fillWidth: true
                Layout.topMargin: -10
    ...
    component LoaderedQuickPanelImplementation: Loader {
        ...
        visible: active
        active: PcConfig.options.sidebar.quickToggles.style === styleName
        Connections {
            ...
            Row {
                ...
                Item {
                    ...
                    CustomIcon {
                        id: distroIcon
                        anchors.fill: parent
                        source: PcConfig.options.custom.distroIcon || SystemInfo.distroIcon
