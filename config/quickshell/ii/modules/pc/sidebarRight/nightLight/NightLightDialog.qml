...
WindowDialog {
    ...
    Column {
        ...
        ConfigSwitch {
            ...
            checked: PcConfig.options.light.night.automatic
            onCheckedChanged: {
                PcConfig.options.light.night.automatic = checked;
            }
        }
        ...
        WindowDialogSlider {
            ...
            value: PcConfig.options.light.night.colorTemperature
            onMoved: PcConfig.options.light.night.colorTemperature = value
    ...
    Column {
        ...
        ConfigSwitch {
            ...
            checked: PcConfig.options.light.antiFlashbang.enable
            onCheckedChanged: {
                PcConfig.options.light.antiFlashbang.enable = checked;
            }
            StyledToolTip {
