...
import qs.modules.pc.sidebarRight.quickToggles.androidStyle
...
AbstractQuickPanel {
    ...
    readonly property int columns: PcConfig.options.sidebar.quickToggles.android.columns
    readonly property list<var> toggles: {
        if (!PcConfig.ready) return []
        const raw = PcConfig.options.sidebar.quickToggles.android.toggles
    ...
    Column {
        ...
        ConfigSpinBox {
            ...
            width: parent.width 
            enabled: PcConfig.options.sidebar.quickToggles.style === "android"
            icon: "add_column_left"
            text: Translation.tr("Columns")
            value: PcConfig.options.sidebar.quickToggles.android.columns
            from: 1
            to: 8
            stepSize: 1
            onValueChanged: {
                PcConfig.options.sidebar.quickToggles.android.columns = value;
            }
        }
    }
}