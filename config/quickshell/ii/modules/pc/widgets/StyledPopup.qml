...
LazyLoader {
    ...
    readonly property bool barVertical: PcConfig.options.bar.vertical
    readonly property string barEdge: {
        if (!barVertical) return PcConfig.options.bar.bottom ? "bottom" : "top"
        return PcConfig.options.bar.bottom ? "right" : "left"
    }
